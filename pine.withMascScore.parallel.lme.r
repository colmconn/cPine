...
modelFormula  = as.formula("fmri ~ group + MASC.tscore")
...
for (contrast in contrasts) {
  ...
  ## ##################################################################################################
  ## # score the MASC raw scores for use in the LME model
  ## ##################################################################################################
  mgd.dim=dim(mgd)
  ...
  ## ##################################################################################################
  ## # end of score the MASC raw scores for use in the LME model
  ## ##################################################################################################
  ...
  model = data.frame(
      ...
      "MASC.tscore" = mgd$MASC.tscore - mean(mgd$MASC.tscore)
    )
